...
import { months, types, priorities } from "./fromData";
...
export default function NewTodoOverlay({ exitFunction }) {
    ...
    return (
        <form className="overlay">
            ...
            {/* Type */}
            <select className={`py-1 w-full border-b-2 border-lightGray ${selectedType ? 'text-black' : 'text-darkGray'}`} value="" onChange={e => setSelectedType(e.target.value)}>
            ...
            {/* Priority */}
            <select className={`py-1 w-full border-b-2 border-lightGray ${selectedPriority ? 'text-black' : 'text-darkGray'}`} value="" onChange={e => setSelectedPriority(e.target.value)}>
            ...
            <div className="flex w-full gap-1">
                ...
                <select className={`py-1 border-b-2 border-r-2 border-lightGray w-32 text-center ${selectedMonth ? 'text-black' : 'text-darkGray'}`} value="" onChange={e => setSelectedMonth(e.target.value)}>
                ...
                {/* Year */}
                <select className={`py-1 border-b-2 border-lightGray w-32 text-center ${selectedYear ? 'text-black' : 'text-darkGray'}`} value="" onChange={e => setSelectedYear(e.target.value)}>
